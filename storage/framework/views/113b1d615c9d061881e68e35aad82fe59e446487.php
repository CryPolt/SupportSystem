...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <?php endif; ?>
            <div class="card">
                <div class="card-header">Зарегестрируйте обращение</div>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('tickets.store')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="author_name" class="col-md-4 col-form-label text-md-right">Ваше имя</label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="author_email" class="col-md-4 col-form-label text-md-right">Ваш Email</label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="title" class="col-md-4 col-form-label text-md-right"><?php echo app('translator')->get('cruds.ticket.fields.title'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="content" class="col-md-4 col-form-label text-md-right"><?php echo app('translator')->get('cruds.ticket.fields.content'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="attachments" class="col-md-4 col-form-label text-md-right"><?php echo e(trans('cruds.ticket.fields.attachments')); ?></label>
...
unset($__errorArgs, $__bag); ?>" id="attachments-dropzone">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crypolt/PhpstormProjects/SupportSystem/resources/views/tickets/create.blade.php ENDPATH**/ ?>